...
def generate_answer(model, cache, tokenizer, question: str, max_new_tokens: int = 128):
    ...
    # Option B: Financial analyst prompt (same as inference_golden_docs.py)
    system_prompt = """You are a financial analyst expert. Based on the company filings and financial documents in the knowledge base, provide detailed and accurate analysis.
...
def main():
    ...
    parser.add_argument("--cache_paths", type=str, nargs="+", required=False,
    ...
    parser.add_argument("--qa_pairs_file", type=str, required=False,
